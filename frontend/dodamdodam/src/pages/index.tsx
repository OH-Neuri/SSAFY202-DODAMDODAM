    ...
    <>
      <div className="flex justify-center items-center bg-b_yellow h-screen">
        ...
        <div className="flex flex-col items-center">
          ...
          <div onClick={()=>router.push('/user/login')} className="cursor-pointer mb-4 flex justify-center items-center w-[280px] font-preR text-[20px] mt-10 bg-yellow-400 hover:bg-yellow-500 text-white rounded-full px-6 py-3">관리자로 로그인하기</div>
          ...
          <div className="text-stone-500">교사 혹은 학부모님은 '도담도담' 앱을 이용해주세요.</div>
        </div>
