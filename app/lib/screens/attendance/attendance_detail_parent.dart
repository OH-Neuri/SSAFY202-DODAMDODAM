                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(child: SizedBox()),
                          InputForm(updateText: _updateBackTime, hint:"귀가 예정 시간",content: (ac.attendacneDetail.backTime ?? "ex) 16:30:00"), enabled: true,isTeacher:false),
                        ],
                      ),
                    ),
                    Padding(
                        ...
                        children: [
                          Expanded(child: Column(
                            ...
                            children: [
                              ...
                              TextFormFieldCustom(updateText:_updateBackWay, hint: (ac.attendacneDetail.backWay ?? "ex) 부모님 픽업"), onChanged: (val){}, obscureText: false, isTeacher: false,)
                            ],
                          ))
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          InputForm(updateText:_updateParentName , hint:"보호자1",content:(ac.attendacneDetail.parentName ?? "ex) 김소정") ,enabled: true,isTeacher:false),
                          Expanded(child: SizedBox()),
                          InputForm(updateText:_updatePhoneNumber, hint:"보호자1 연락처",content:(ac.attendacneDetail.phoneNumber ?? "ex) 01000000000"),enabled: true,isTeacher:false),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          InputForm(updateText: _updateTempParentName, hint:"보호자2",content:(ac.attendacneDetail.tempParentName ?? "ex) 김지현"), enabled: true,isTeacher:false),
                          Expanded(child: SizedBox()),
                          InputForm(updateText: _updateTempPhoneNumber ,hint:"보호자2 연락처",content:(ac.attendacneDetail.tempPhoneNumber ?? "ex) 01000000000") ,enabled: true,isTeacher:false),
                        ],
                      ),
                    )
                  ],
