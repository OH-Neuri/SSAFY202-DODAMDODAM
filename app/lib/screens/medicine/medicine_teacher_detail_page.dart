...
class MedicineTeacherDetailPage extends StatefulWidget {

  const MedicineTeacherDetailPage({Key? key}) : super(key: key);
  _MedicineTeacherDetailPageState createState() => _MedicineTeacherDetailPageState();
}

class _MedicineTeacherDetailPageState extends State<MedicineTeacherDetailPage> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    TextDivider.horizontal(text: const Text('◆',style: TextStyle(
                      fontSize: 14,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(onPressed: (){}, child: Text("서명하기",style: TextStyle(
                            fontSize: 16
                          ),),
